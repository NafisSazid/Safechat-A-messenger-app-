...
public class CreateGroupChat extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String userNameCreator=username(mFirebaseUser.getEmail().toString());
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                mDatabase.child("users").child("GroupNames").child(gn).child("messages").push()
                        .child("title").setValue("  "+userNameCreator+"  "+"orkahcitrob"+"  " +"Welcome all from  Group Creator :) ");
