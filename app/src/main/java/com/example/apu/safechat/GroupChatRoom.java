...
public class GroupChatRoom extends AppCompatActivity {
   ...
   // private DatabaseReference mDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //my adapter
        ArrayList<User> arrayOfUsers1 = new ArrayList<User>();
        // Create the adapter to convert the array to views
        final UserAdapter adapter = new UserAdapter(this, arrayOfUsers1);
        ...
        mFirebaseAuth = FirebaseAuth.getInstance();
        mFirebaseUser = mFirebaseAuth.getCurrentUser();
        name=username(mFirebaseUser.getEmail().toString());
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                mDatabase.child("users").child("GroupNames").child(choosenContact).child("messages")
                        .push().child("title").setValue("  "+name+"  "+"orkahcitrob"+"  " +text.getText().toString());
                text.setText("");
            }
        });
